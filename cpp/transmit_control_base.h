#ifndef TRANSMIT_CONTROL_IMPL_BASE_H
#define TRANSMIT_CONTROL_IMPL_BASE_H
...
class transmit_control_base : public Device_impl
{
    public:
        transmit_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl);
        transmit_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        transmit_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        transmit_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
    ...
    protected:
        ProcessThread<transmit_control_base> *serviceThread; 
        boost::mutex serviceThreadLock;

        // Member variables exposed as properties
        std::string device_kind;
        std::string device_model;
        CORBA::Long gpio_en_pin;
        bool transmit_enable;
        CORBA::Long audio_en_pin;
        bool audio_enable;
