...
class DeviceTests(ossie.utils.testing.ScaComponentTestCase):
    """Test for all device implementations in transmit_control"""
    ...
    # for modules that will assist with testing devices with BULKIO ports
    
if __name__ == "__main__":
    ossie.utils.testing.main("../transmit_control.spd.xml") # By default tests all implementations
